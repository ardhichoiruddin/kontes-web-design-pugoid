...
$('.slider-news').slick({
	...
	variableWidth: true,
	arrows: true,
	prevArrow: $(".btn-next-prev .before-front-slider"),
	nextArrow: $(".btn-next-prev .next-front-slider"),
	responsive: [
	{
		breakpoint: 1030,
		settings: {
	...
	onAfterChange: function(slide, index){
		...
		console.log($('.slick-news .slick-list .slick-slide').attr('data-slick-index','0'));
	}
  });
